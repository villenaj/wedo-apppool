...
public function inviteInterview(Request $request){
    ...
    $dd = [
        'title' => "Dear " . $data->first .',',
        'body' =>"Thank you for applying for the position of " . $data->pos . " with WeDo Inc." . PHP_EOL ."

        Something\r\nOn\r\nA\r\nNew\r\nLine


        We would like to invite you to come to our office to interview for the position. Your interview has been scheduled for 1 pm on May 10, 2022, at addres sa pasig. " . PHP_EOL ."
